import svgPaths from "./svg-238az3ti3v";
...
function Bg() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col items-start left-1/2 top-[874px]" data-name="BG">
...
function Container() {
  return (
    <div className="[word-break:break-word] absolute content-stretch flex flex-col h-[874px] items-start justify-between left-0 not-italic py-[48px] text-[#ffe16c] text-center top-0 w-[402px]" data-name="Container">
      <Frame />
      <Frame1 />
      <Frame2 />
    </div>
...
function Button() {
  return (
    <div className="[word-break:break-word] bg-[#ffe16c] content-stretch flex gap-[12px] items-center justify-center not-italic px-[36px] py-[2px] relative rounded-[1000px] shrink-0 text-black text-center whitespace-nowrap" data-name="Button">
...
function Section() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-center left-0 px-[64px] py-[80px] top-[906px] w-[402px]" data-name="Section">
      <Group />
      <Text />
      <Button />
      <Group3 />
...
function Frame8() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-center relative shrink-0 text-center text-white w-full">
      <p className="font-['PP_Pangaia:Ultralight',sans-serif] leading-[1.15] not-italic relative shrink-0 text-[36px] tracking-[-0.72px] whitespace-nowrap">Accomodation</p>
      <p className="font-['Cormorant_Garamond:Medium_Italic',sans-serif] font-medium italic leading-[normal] min-w-full relative shrink-0 text-[18px] tracking-[-0.09px] w-[min-content]">Rooms Hotel Batumi. Let’s make memories that will last a lifetime!</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="bg-[#77adff] content-stretch flex h-[46px] items-center justify-center px-[36px] py-[2px] relative rounded-[1000px] shrink-0" data-name="Frame">
...
function Thumbnail() {
  return (
    <div className="bg-white h-[213px] overflow-clip relative shrink-0 w-[320px]" data-name="Thumbnail">
      <div className="-translate-y-1/2 absolute h-[213px] left-0 top-1/2 w-[320px]" data-name="image 5">
...
function Frame7() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start leading-[1.15] min-h-px not-italic relative text-black text-center w-full">
      <p className="font-['PP_Pangaia:Medium',sans-serif] relative shrink-0 text-[16px] tracking-[-0.32px] w-full">Junior King Room Old Town View</p>
      <p className="font-['Google_Sans_Flex:Regular',sans-serif] font-normal opacity-60 relative shrink-0 text-[11px] tracking-[-0.22px] w-full" style={{ fontVariationSettings: '"GRAD" 0, "ROND" 0, "wdth" 100' }}>
        A spacious room features with a king-size bed, wooden accents, a balcony and a sitting area. Enjoy views of the old town.
      </p>
    </div>
  );
}
...
function Card() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[8px] h-[310px] items-start p-[12px] relative shrink-0" data-name="Card">
      <Thumbnail />
      <Frame7 />
    </div>
  );
...
function Thumbnail1() {
  return (
    <div className="bg-white h-[213px] overflow-clip relative shrink-0 w-[320px]" data-name="Thumbnail">
      <div className="-translate-y-1/2 absolute h-[213px] left-0 top-1/2 w-[320px]" data-name="image 6">
...
function Frame9() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start leading-[1.15] min-h-px not-italic relative text-black text-center w-full">
      <p className="font-['PP_Pangaia:Medium',sans-serif] relative shrink-0 text-[16px] tracking-[-0.32px] w-full">Signature King Room Old Town View</p>
      <p className="font-['Google_Sans_Flex:Regular',sans-serif] font-normal opacity-60 relative shrink-0 text-[11px] tracking-[-0.22px] w-full" style={{ fontVariationSettings: '"GRAD" 0, "ROND" 0, "wdth" 100' }}>
        A large room with a king-size bed, wooden accents, a sitting area and a balcony with old-town views.
      </p>
    </div>
  );
}
...
function Card1() {
  return (
    <div className="bg-white relative self-stretch shrink-0" data-name="Card">
...
function Thumbnail2() {
  return (
    <div className="bg-white h-[213px] overflow-clip relative shrink-0 w-[320px]" data-name="Thumbnail">
      <div className="absolute h-[427px] left-0 top-[-107px] w-[320px]" data-name="image 7">
...
function Frame10() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start leading-[1.15] min-h-px not-italic relative text-black text-center w-full">
      <p className="font-['PP_Pangaia:Medium',sans-serif] relative shrink-0 text-[16px] tracking-[-0.32px] w-full">Signature King Room Sea View</p>
      <p className="font-['Google_Sans_Flex:Regular',sans-serif] font-normal opacity-60 relative shrink-0 text-[11px] tracking-[-0.22px] w-full" style={{ fontVariationSettings: '"GRAD" 0, "ROND" 0, "wdth" 100' }}>
        This room offers a king-size bed, wooden accents, a sitting area and a balcony with sea views.
      </p>
    </div>
  );
}
...
function Carousel() {
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-[354px]" data-name="Carousel">
      <Card />
      <Card1 />
      <Card2 />
    </div>
...
function Frame3() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[64px] items-start left-0 px-[24px] py-[64px] top-[2297px] w-[402px]">
...
function Frame11() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-center relative shrink-0 text-black text-center w-full">
      <p className="font-['PP_Pangaia:Ultralight',sans-serif] leading-[1.15] not-italic relative shrink-0 text-[36px] tracking-[-0.72px] whitespace-nowrap">What to Wear</p>
      <p className="font-['Cormorant_Garamond:Medium_Italic',sans-serif] font-medium italic leading-[normal] min-w-full relative shrink-0 text-[18px] tracking-[-0.09px] w-[min-content]">{`Dress Code & Palette`}</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-center justify-center left-[24px] top-[3177px] w-[354px]" data-name="Frame">
      <Asset />
      <Frame11 />
    </div>
  );
...
function Group7() {
  return (
    <div className="absolute inset-[0_0_0.03%_-0.01%]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" height="26.183" preserveAspectRatio="none" viewBox="0 0 18.0016 26.183" width="18.0016">
        <g id="Group">
...
function Asset1() {
  return (
    <div className="absolute flex h-[141.762px] items-center justify-center left-[290.04px] top-[4099.67px] w-[125.001px]">
...
function Frame15() {
  return (
    <div className="absolute flex h-[170.041px] items-center justify-center left-[18px] top-[3818px] w-[198.78px]">
      <div className="flex-none rotate-[-16.06deg]">
        <div className="[word-break:break-word] content-stretch flex flex-col font-['Homemade_Apple:Regular',sans-serif] gap-[10px] items-start leading-[1.5] not-italic relative text-[#ffe16c] w-[170px]">
          ...
          <p className="relative shrink-0 text-[23px] tracking-[-0.46px] w-full">Colorful Attire</p>
        </div>
      </div>
    </div>
  );
...
function Frame16() {
  return (
    <div className="absolute flex h-[147.141px] items-center justify-center left-[58px] top-[4361px] w-[316.638px]">
      <div className="flex-none rotate-[-10.33deg]">
        <div className="[word-break:break-word] content-stretch flex flex-col font-['Homemade_Apple:Regular',sans-serif] gap-[11px] items-start leading-[1.5] not-italic relative text-[#7a843e] w-[304.718px]">
          ...
          <p className="relative shrink-0 text-[23px] w-full whitespace-pre-wrap">{`Black  Suit  White  Shirt`}</p>
        </div>
      </div>
    </div>
  );
...
function Frame19() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-center relative shrink-0 text-black text-center w-full">
      <p className="font-['PP_Pangaia:Ultralight',sans-serif] leading-[1.15] not-italic relative shrink-0 text-[36px] tracking-[-0.72px] whitespace-nowrap">RSVP</p>
      <div className="font-['Cormorant_Garamond:Medium_Italic',sans-serif] font-medium italic leading-[0] min-w-full relative shrink-0 text-[18px] tracking-[-0.09px] w-[min-content] whitespace-pre-wrap">
        <p className="leading-[normal] mb-0">{`Please let us know if you’ll be joining us by `}</p>
        <p className="leading-[normal]">September 20</p>
      </div>
    </div>
  );
}
...
function Radio() {
  return (
    <div className="relative rounded-[24px] shrink-0 size-[16px]" data-name="Radio">
      <div aria-hidden className="absolute border-6 border-[#77adff] border-solid inset-0 pointer-events-none rounded-[24px]" />
    </div>
  );
}
...
function RadioButton() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0" data-name="Radio Button">
      <Radio />
      <p className="[word-break:break-word] font-['Cormorant_Garamond:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[18px] text-black text-center tracking-[-0.09px] whitespace-nowrap">Yes, I’ll be there</p>
    </div>
  );
}
...
function Radio1() {
  return (
    <div className="relative rounded-[24px] shrink-0 size-[16px]" data-name="Radio">
      <div aria-hidden className="absolute border-2 border-[#999] border-solid inset-0 pointer-events-none rounded-[24px]" />
    </div>
  );
}
...
function RadioButton1() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0" data-name="Radio Button">
      <Radio1 />
      <p className="[word-break:break-word] font-['Cormorant_Garamond:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[18px] text-[rgba(0,0,0,0.6)] text-center tracking-[-0.09px] whitespace-nowrap">Sorry, I can’t make it</p>
    </div>
  );
}
...
function InputContainer() {
  return (
    <div className="bg-[rgba(255,255,255,0.2)] flex-[1_0_0] min-h-px relative rounded-[12px] w-full" data-name="Input Container">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[12px] py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Cormorant_Garamond:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[18px] text-black tracking-[-0.09px] w-full">{`Lezho & Gvanca`}</p>
        </div>
      </div>
    </div>
  );
...
function Frame22() {
  return (
    <div className="bg-[#77adff] h-[46px] relative rounded-[1000px] shrink-0 w-full" data-name="Frame">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[36px] py-[2px] relative size-full">
          <p className="[word-break:break-word] font-['PP_Pangaia:Ultralight',sans-serif] leading-[1.15] not-italic relative shrink-0 text-[24px] text-black text-center tracking-[-0.48px] whitespace-nowrap">Send RSVP</p>
        </div>
      </div>
    </div>
  );
...
function Frame17() {
  return (
    <div className="-translate-x-1/2 absolute bottom-[584px] content-stretch flex flex-col gap-[48px] items-center left-1/2 pb-[24px] pt-[8px] px-[24px] w-[402px]">
...
function Frame23() {
  return (
    <div className="[word-break:break-word] absolute bottom-[367px] content-stretch drop-shadow-[0px_4px_2px_rgba(0,0,0,0.25)] flex flex-col gap-[10px] h-[92px] items-center left-0 text-center w-[402px] whitespace-nowrap">
      <Frame24 />
      <p className="font-['Cormorant_Garamond:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[18px] text-white tracking-[-0.09px]">Made with love ❤️ by Lezho</p>
    </div>
  );
}
...
export default function Landing() {
  return (
    <div className="bg-white relative size-full" data-name="Landing">
      ...
      <Bg />
      <div className="-translate-x-1/2 absolute bottom-0 h-[550px] left-[calc(50%+0.5px)] w-[411px]" data-name="Subtract">
        <img alt="" className="absolute block inset-0 max-w-none size-full" height="550" src={imgSubtract} width="411" />
      </div>
      <div className="absolute h-[907.082px] left-0 top-0 w-[402px]" data-name="Hero Thumbnail">
        <img alt="" className="absolute block inset-0 max-w-none size-full" height="907.082" src={imgHeroThumbnail} width="402" />
      </div>
      <Container />
      <Section />
      <Frame3 />
      <Frame6 />
      <div className="absolute flex h-[665.096px] items-center justify-center left-[-119.28px] mix-blend-darken top-[1370px] w-[687.569px]">
        <div className="flex-none rotate-[-36.48deg]">
          <div className="h-[429.928px] relative w-[537.218px]" data-name="ChatGPT-Image-Jul-30,-2026,-05_33_46-PM 1">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgChatGptImageJul302026053346Pm1} />
          </div>
        </div>
      </div>
      <LocationPin />
      <p className="[word-break:break-word] absolute font-['Homemade_Apple:Regular',sans-serif] leading-[1.15] left-[33px] not-italic text-[#7a843e] text-[23px] top-[1439.57px] tracking-[-0.46px] w-[162px]">The Wedding will take place at</p>
      <Frame12 />
      <div className="absolute flex h-[316.778px] items-center justify-center left-[209.47px] top-[3370.11px] w-[239.056px]">
      ...
      <div className="absolute flex h-[327.918px] items-center justify-center left-[217px] top-[3723px] w-[250.549px]">
      ...
      <div className="absolute flex h-[405.889px] items-center justify-center left-[-5px] top-[4000px] w-[334.43px]">
      ...
      <Asset1 />
      <div className="absolute flex h-[371.003px] items-center justify-center left-[-34px] top-[3617px] w-[285.108px]">
      ...
      <div className="absolute flex h-[290.284px] items-center justify-center left-[1.34px] top-[3340.86px] w-[215.325px]">
