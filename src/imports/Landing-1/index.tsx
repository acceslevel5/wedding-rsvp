...
function Bg() {
  ...
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col items-start left-1/2 top-[710px] overflow-hidden" style={{ height: "6830px" }} data-name="BG">
      {tiles.map((_, idx) => (
...
export default function Landing({
  ...
  return (
    <div className="relative w-[402px] h-[8619px]" data-name="Landing">
      <div className="absolute left-[79px] size-[254px] top-[8700px]" data-name="O Sole Mio 1" />
      <Bg />
